Locales['de'] = {
  ...
  ['whitenight_wear'] = 'Arbeitskleidung',
  ...
  ['being_searched'] = 'you are being ~y~searched~s~ by the ~b~WhiteNight~s~',
  -- Vehicle interaction
